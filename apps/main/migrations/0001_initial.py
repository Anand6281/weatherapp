...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['latitude', 'longitude', 'last_updated'], name='main_weathe_latitud_f4fe18_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather_forecast', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hourly_forecasts', to='main.weatherforecast')),
            ],
            options={
                'indexes': [models.Index(fields=['weather_forecast', 'time'], name='main_hourly_weather_6a3e7d_idx')],
